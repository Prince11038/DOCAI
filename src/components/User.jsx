  ...
  return (
    <StyledWrapper>
      <div className="template">
        <div tabIndex={0} className="popup button" style={{padding: '2 0.225rem  0', borderTopRightRadius: '1.2rem', borderBottomRightRadius: '1.2rem'}}>
          <div className="popup-header">
            <p style={{letterSpacing: 1, fontWeight: 600, padding: '0.925rem 0.2rem 0.625rem 0.825rem'}}>
              Prince Kumar Singh
            </p>
